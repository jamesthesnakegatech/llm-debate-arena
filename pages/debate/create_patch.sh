...
cp pages/debate/\[id\].tsx pages/debate/\[id\].tsx.backup

# Create the updated file
cat > pages/debate/\[id\].tsx << 'EOF'
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          {/* Generate Next Turn - Hidden when auto-continue is active */}
           ...
           !isGenerating && (
            <div className="bg-white rounded-lg shadow-sm p-6 text-center mb-6">
              <p className="text-gray-600">
                Auto-continuing debate... Turn {debate.turns.length + 1} of {MAX_TURNS} coming up!
              </p>
            </div>
          )}
...
echo "✅ Debate page updated successfully!"
echo ""
echo "Key changes made:"
echo "  1. Added auto-continue logic that triggers every 3 seconds"
echo "  2. Fixed status display (created/in_progress/completed)"
echo "  3. Removed page reload on debate start"
echo "  4. Fixed response handling for turn data"
echo "  5. Improved status message during auto-continue"
echo ""
echo "Backup saved to: pages/debate/[id].tsx.backup"
echo ""
echo "Now restart your dev server and create a new debate to test!"
